	...
	return (
		<div className='min-h-screen flex items-center justify-center px-4'>
			<motion.div
				...
				className='max-w-md w-full bg-[#3D2A33] rounded-lg shadow-xl overflow-hidden relative z-10'
			>
				<div className='p-6 sm:p-8'>
					...
					<div className='space-y-4'>
						<Link
							to={"/"}
							className='w-full bg-[#2D1C24] hover:bg-[#3D2A33] text-pink-100 font-bold py-2 px-4 rounded-lg transition duration-300 flex items-center justify-center'
						>
