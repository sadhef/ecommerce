	...
	return (
		...
		>
			<div className='space-y-4'>
				<div>
					<label htmlFor='voucher' className='mb-2 block text-sm font-medium text-pink-100'>
						Do you have a voucher or gift card?
					</label>
					<input
						type='text'
						id='voucher'
						className='block w-full rounded-lg border border-[#FF6B9C]/30 bg-[#2D1C24] 
            p-2.5 text-sm text-white placeholder-pink-300/50 focus:border-[#FF6B9C] 
            focus:ring-[#FF6B9C]'
			...
			{isCouponApplied && coupon && (
				<div className='mt-4'>
					<h3 className='text-lg font-medium text-pink-100'>Applied Coupon</h3>
			...
			{coupon && (
				<div className='mt-4'>
					<h3 className='text-lg font-medium text-pink-100'>Your Available Coupon:</h3>
					<p className='mt-2 text-sm text-pink-200'>
						{coupon.code} - {coupon.discountPercentage}% off
					</p>
				</div>
